...
namespace ZQCTP
{
    ...
    public class FtdcMdAdapter : IDisposable
    {
        ...
        /// </summary>
        public FtdcMdAdapter(string pszFlowPath, bool bIsUsingUdp)
        {
            Handle = Interop.MdCreateApi(pszFlowPath, bIsUsingUdp);
        ...
        ///@remark
        /// </summary>
        public int SubscribeMarketData(string[] ppInstrumentID, string pExchageID)
        {
            return Interop.MdSubscribeMarketData(Handle, ppInstrumentID, ppInstrumentID.Length, pExchageID);
        }
        ...
        ///@remark
        /// </summary>
        public int UnSubscribeMarketData(string[] ppInstrumentID, string pExchageID)
        {
            return Interop.MdUnSubscribeMarketData(Handle, ppInstrumentID, ppInstrumentID.Length, pExchageID);
        }
